...
#import "LYRealtimeSearchUtil.h"

static LYRealtimeSearchUtil *defaultUtil = nil;

@interface LYRealtimeSearchUtil()
...
@implementation LYRealtimeSearchUtil
...
+ (instancetype)currentUtil
{
    ...
    dispatch_once(&onceToken, ^{
        defaultUtil = [[LYRealtimeSearchUtil alloc] init];
    });
